...
# One-time signing setup for Copilot. Generates a fresh release keystore and a
...
#
# BACK UP keystore/copilot-release.jks somewhere safe after running this. If you
# lose it you can never ship an update over an installed Copilot again — you'd
...
echo "BACK UP $KEYSTORE now — losing it means you can never update an installed Copilot again."
